package com.adamatomic.flixel
{
	...
	public class FlxG
	{
		...
		static public function flash(Color:uint, Duration:Number=1):void { _flash(Color,Duration); }
		...
		static public function fade(Color:uint, Duration:Number=1, FadeComplete:Function=null):void { _fade(Color,Duration,FadeComplete); }
