package com.adamatomic.Mode
{
	...
	public class PlayState extends FlxState
	{
		...
		override public function update():void
		{
			...
			FlxBlock.collideArrays(_blocks,_bullets);
			FlxBlock.collideArrays(_blocks,_botBullets);
			FlxBlock.collideArrays(_blocks,_bots);
			FlxBlock.collideArray(_blocks,_player);
			
			//collisions between sprites
			FlxSprite.overlapArrays(_bullets,_bots,bulletHitBot);
			FlxSprite.overlapArrays(_bullets,_spawners,bulletHitBot);
			FlxSprite.overlapArray(_bots,_player,botHitPlayer);
			FlxSprite.overlapArray(_spawners,_player,botHitPlayer);
			FlxSprite.overlapArray(_botBullets,_player,bulletHitBot);
